        ...
        <div className='d-flex justify-content-around '>
          <div className='mt-5 '>y
            <div className='p-5  border rounded-3 d-flex flex-column'>
              <h4 className='fw-semibold mb-5'>Enter the original price and the discount rate 🛍️</h4>
          ...
          <div className='mt-5 '>
            <div className='p-5 border rounded-3 d-flex flex-column h-100 justify-content-around'>
              ...
              <h3 className='fw-semibold mb-5 text-center  mx-5 px-5 text-success'>{discountRate}% discount on ₹{originalPrice} is:</h3>
          
              </div>
              
              <h1 className='text-danger mb-5 fw-bold text-center' style={{fontSize:'3.5rem'}}>₹{discountedPrice}</h1>
            </div>
          </div>
        </div>
